...
class RRCNN_Block(nn.Module):
    def __init__(self, in_chs, out_chs, t=2):
        ...
        self.RCNN = nn.Sequential(Recurrent_Block(out_chs, t=t), Recurrent_Block(out_chs, t=t))
...
class UNet_Down(nn.Module):
    def __init__(self, in_chs, out_chs, model="UNet"):
        ...
        if self.model == "UNet" or self.model == "Attention_UNet":
            self.maxpool_conv = nn.Sequential(nn.MaxPool2d(2), Conv_Block(in_chs, out_chs))
        elif self.model == "R2UNet" or self.model == "Attention_R2UNet":
            self.maxpool_conv = nn.Sequential(nn.MaxPool2d(2), RRCNN_Block(in_chs, out_chs))
